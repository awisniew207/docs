...
<Columns cols={3}>
  <Card title="Quick Start" icon="rocket" href="/developers/ability-developers/quick-start" color="#FF4205">
    Build your first ability
  </Card>
  <Card title="Starter Kit" icon="code" href="https://github.com/LIT-Protocol/vincent-starter-kit" color="#FF4205">
    Clone the complete development environment
  </Card>
  <Card title="Creating Abilities" icon="hammer" href="/developers/ability-developers/creating-abilities" color="#FF4205">
...
<Columns cols={2}>
  <Card title="deBridge" icon="link" href="/developers/abilities/debridge" color="#FF4205">
...
<Columns cols={2}>
  ...
  <Card title="Apps" icon="cube" href="/developers/app-agent-developers/getting-started" color="#FF4205">
