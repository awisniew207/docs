...
<AccordionGroup>
  ...
  <Accordion title="Can users revoke access to my App?" icon="user-x">
    Yes, users can manage their App authorizations through their Vincent Wallet. If access is revoked, authentication will fail and they'll need to go through the Connect flow again as a new user.
  </Accordion>
</AccordionGroup>
