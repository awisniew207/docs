...
Create your first Vincent Ability in under 5 minutes using the Vincent Starter Kit.
...
<CardGroup cols={3}>
  ...
  <Card title="Testing Guide" icon="flask" href="/abilities/testing">
    Write comprehensive tests for your Ability
  </Card>
</CardGroup>
