...
<Info>
**Note**: In this guide, you'll create and register your first Vincent App using the [Vincent App Dashboard](https://dashboard.heyvincent.ai/). You'll select from existing Vincent Abilities, optionally enable their supported Vincent Policies, configure your App's details, and register the App Delegatees whom are authorized to execute your App's Abilities.

If you're unfamiliar with what a Vincent App is, checkout the [Getting Started](./Getting-Started) guide to learn more.
</Info>
...
<Info>
**Note**: [Content will need manual adjustment]
</Info>
