      ...
      return {
        vincentApi: {
          consentPage: {
            ...
            isLitActionApproved: bindContext(VincentLitActionViewFacet.isLitActionApproved),
            permitAppVersion: bindContext(VincentUserFacet.permitAppVersion),
            removeLitActionApprovals: bindContext(VincentLitActionFacet.removeLitActionApprovals),
            setToolPolicyParameters: bindContext(VincentUserFacet.setToolPolicyParameters),
            unPermitAppVersion: bindContext(VincentUserFacet.unPermitAppVersion),
          },
          appManagerDashboard: {
            addAuthorizedRedirectUri: bindContext(VincentAppFacet.addAuthorizedRedirectUri),
            deleteApp: bindContext(VincentAppFacet.deleteApp),
            updateAppDeploymentStatus: bindContext(VincentAppFacet.updateAppDeploymentStatus),
            ...
            registerNextAppVersion: bindContext(VincentAppFacet.registerNextAppVersion),
            removeAuthorizedRedirectUri: bindContext(VincentAppFacet.removeAuthorizedRedirectUri),
          ...
          litManager: {
            getAllApprovedLitActions: VincentLitActionViewFacet.getAllApprovedLitActions,
            getApprovedLitActionsManager: VincentLitActionViewFacet.getApprovedLitActionsManager,
            removeLitActionApprovals: bindContext(VincentLitActionFacet.removeLitActionApprovals),
          ...
          userDashboard: {
            ...
            getAllRegisteredAgentPkps: bindContext(VincentUserViewFacet.getAllRegisteredAgentPkps),
            ...
            permitAppVersion: bindContext(VincentUserFacet.permitAppVersion),
            removeToolPolicyParameters: bindContext(VincentUserFacet.removeToolPolicyParameters),
            setToolPolicyParameters: bindContext(VincentUserFacet.setToolPolicyParameters),
            unPermitAppVersion: bindContext(VincentUserFacet.unPermitAppVersion),
          },
          unknown: {
            getAppByDelegatee: bindContext(VincentAppViewFacet.getAppByDelegatee),
