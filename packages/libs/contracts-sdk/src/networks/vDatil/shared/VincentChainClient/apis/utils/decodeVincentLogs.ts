...
export const decodeVincentLogs = async (
  ...
  contractABIs.set(vincentAppFacetContract.address.toLowerCase(), vincentAppFacetContract.abi);
  contractABIs.set(
  ...
  contractABIs.set(vincentUserFacetContract.address.toLowerCase(), vincentUserFacetContract.abi);
  contractABIs.set(
