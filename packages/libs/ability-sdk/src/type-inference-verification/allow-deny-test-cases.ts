...
export function testAllowFunctionWithDifferentTypes() {
  ...
  const allowFuncDiffTypesPolicy = createVincentPolicy({
    ...
    abilityParamsSchema: z.object({ actionType: z.string() }),
  ...
  const test1 = createVincentAbilityPolicy({
  ...
  const test2 = createVincentAbilityPolicy({
    abilityParamsSchema: baseAbilitySchema,
    bundledVincentPolicy: asBundledVincentPolicy(
  ...
  const test3 = createVincentAbilityPolicy({
    abilityParamsSchema: baseAbilitySchema,
    bundledVincentPolicy: asBundledVincentPolicy(
  ...
  return {
    ...
    test2,
    test3,
    test4: createVincentAbilityPolicy({
      abilityParamsSchema: baseAbilitySchema,
      bundledVincentPolicy: asBundledVincentPolicy(
        allowFuncNoSchema,
...
export function testCommitAllowDeny() {
  ...
  return createVincentAbilityPolicy({
    abilityParamsSchema: baseAbilitySchema,
    bundledVincentPolicy: asBundledVincentPolicy(
