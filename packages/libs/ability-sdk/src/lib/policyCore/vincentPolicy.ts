...
>(
  PolicyConfig: VincentPolicyConfig<
    ...
    CommitAllowResult,
    CommitDenyResult,
    PolicyConfigLifecycleFunction<PolicyAbilityParams, UserParams, EvalAllowResult, EvalDenyResult>,
    PolicyConfigLifecycleFunction<
      PolicyAbilityParams,
      UserParams,
      PrecheckAllowResult,
  ...
  const vincentPolicy: VincentPolicy<
    ...
    CommitAllowResult,
    CommitDenyResult,
    PolicyLifecycleFunction<PolicyAbilityParams, UserParams, EvalAllowResult, EvalDenyResult>,
    PolicyLifecycleFunction<
      PolicyAbilityParams,
      UserParams,
      PrecheckAllowResult,
 ...
 * @category API Methods
 */
export function createVincentAbilityPolicy<
...
>(config: {
  ...
  const {
    bundledVincentPolicy: { vincentPolicy, ipfsCid, vincentAbilityApiVersion },
  } = config;
  ...
  return result as {
    ...
    /** @hidden */
    vincentAbilityApiVersion: typeof vincentAbilityApiVersion;
    /** @hidden */
    __schemaTypes: {
