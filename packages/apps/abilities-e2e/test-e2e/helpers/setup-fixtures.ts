...
/**
 * Permits all of the abilities for the Agent Wallet PKP
 * @param abilityIpfsCids - Array of ability IPFS CIDs to permit
 * @param testConfig - Test configuration
 */
export async function permitAbilitiesForAgentWalletPkp(
