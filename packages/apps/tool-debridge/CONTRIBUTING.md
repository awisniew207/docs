# Contributing to Vincent Tool Debridge

This document provides guidelines for contributing to the Vincent Tool Debridge project.

## Overview

The Vincent Tool Debridge is a tool to send deposit, withdraw or redeem Debridge transactions from a Vincent app on behalf of the delegator. It's part of the Vincent Tools ecosystem and is built using the Vincent Tool SDK.
