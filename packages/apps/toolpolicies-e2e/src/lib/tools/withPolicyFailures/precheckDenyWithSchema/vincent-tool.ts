...
const precheckDenyWithSchemaPolicy = createVincentToolPolicy({
...
/**
 * Tool with policy that denies during precheck with schema
 * Test:
...
export const vincentTool = createVincentTool({
  ...
  toolParamsSchema: toolParams,
  supportedPolicies: supportedPoliciesForTool([precheckDenyWithSchemaPolicy]),
