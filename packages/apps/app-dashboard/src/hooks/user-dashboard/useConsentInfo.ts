...
export const useConsentInfo = (appId: string): ConsentInfoState => {
  ...
  const [triggerListAppVersionTools, { isLoading: toolsLoading, isError: toolsError }] =
  ...
  const [triggerGetTool, { isLoading: toolsInfoLoading, isError: toolsInfoError }] =
    vincentApiClient.useLazyGetToolQuery();
  const [triggerGetPolicy, { isLoading: policiesInfoLoading, isError: policiesInfoError }] =
