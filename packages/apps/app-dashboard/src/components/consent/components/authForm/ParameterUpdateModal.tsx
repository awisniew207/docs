  ...
  return (
    <div className="mt-6">
      ...
      {isVersionEnabled === false && (
        <div className="bg-blue-50 border border-blue-100 rounded-md p-4 mb-6">
          <p className="text-sm text-gray-700">
            <span className="font-medium">Notice:</span> Version {permittedVersion} has been
            disabled by the app developer. Please contact the application developer for more
            information or try using a different application.
          </p>
        </div>
      )}
      ...
      <div className="flex flex-col space-y-3">
        ...
        <Button onClick={onContinue}>Continue with Existing Policies</Button>
      </div>
    </div>
  );
};
