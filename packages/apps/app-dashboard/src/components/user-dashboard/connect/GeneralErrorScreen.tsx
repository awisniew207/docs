      ...
      >
        ...
        <div className="px-6 py-8 space-y-6">
          ...
          <InfoBanner
            ...
            message="We encountered an error while loading the connect information. Please try again or go back to continue."
          />
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className={`text-sm ${themeStyles.textMuted} mt-1`}>
                      We're unable to load the connect information at this time.
                    </p>
                  </div>
                </div>
