      ...
      >
        ...
        <div className="px-6 py-8 space-y-6">
          ...
          <InfoBanner
            ...
            message="You've previously granted permissions to this app. You can continue with your existing settings or update them."
          />
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <ActionCard
                    ...
                    description="Review and update your app settings on the dashboard"
                  ...
                  <ActionCard
                    ...
                    description="Proceed with your existing settings"
