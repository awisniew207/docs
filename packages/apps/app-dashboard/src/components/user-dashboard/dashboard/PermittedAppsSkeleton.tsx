            ...
            <CardContent className="p-3">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className={`w-4 h-4 rounded ${theme.itemBg} animate-pulse`}></div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className={`h-3 w-16 rounded ${theme.itemBg} animate-pulse`}></div>
                  <div className={`h-5 w-8 rounded ${theme.itemBg} animate-pulse`}></div>
                </div>
              </div>
            </CardContent>
          </Card>
