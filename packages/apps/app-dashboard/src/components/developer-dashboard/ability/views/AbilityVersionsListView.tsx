    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <h1 className="text-3xl font-bold text-neutral-800 dark:text-white">Ability Versions</h1>
          <p className="text-gray-600 dark:text-white/60 mt-2">
            All versions for <span className="font-mono">{ability.packageName}</span>
          </p>
          <div className="flex items-center gap-2 mt-3">
            ...
            >
              ...
              Active: {ability.activeVersion}
            </Badge>
            <Badge
              variant="outline"
              className="bg-gray-50 dark:bg-neutral-800 text-gray-700 dark:text-white/80 border-gray-200 dark:border-gray-600"
            >
      ...
      {activeVersions.length === 0 && (
        <div className="bg-white shadow rounded-lg p-8 text-center">
          ...
          <h3 className="text-lg font-medium text-neutral-800 mb-2">No versions found</h3>
          <p className="text-gray-600">
            This ability doesn't have any versions yet. Create the first version to get started.
          </p>
        </div>
      )}
      ...
      {deletedVersions.length > 0 && (
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium text-gray-600 mb-4">Deleted Ability Versions</h3>
            <div className="space-y-4">
