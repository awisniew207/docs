...
export function DeleteAbilityVersionWrapper() {
  ...
  useEffect(() => {
    if (isSuccess && data) {
      navigate(`/developer/abilityId/${encodeURIComponent(packageName!)}/versions`); // Navigate immediately, no delay needed
    }
      ...
      <div className="w-full max-w-2xl mx-auto">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-900">Delete Ability Version</h1>
