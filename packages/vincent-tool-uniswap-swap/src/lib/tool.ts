...
): VincentTool<UniswapSwapLitActionParameters> => ({
  name: 'UniswapSwap',
 ...
 * @type {Record<SupportedLitNetwork, VincentTool<UniswapSwapLitActionParameters>>}
 */
export const UniswapSwap = Object.entries(NETWORK_CONFIGS).reduce(
  ...
  {} as Record<SupportedLitNetwork, VincentTool<UniswapSwapLitActionParameters>>
);