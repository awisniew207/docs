...
(async () => {
    ...
    const ERC20_APPROVAL_TOOL_IPFS_ID = 'QmWWN2mWpoGi3uTZBmYHdwYenGLkfj18NvmhBTqgSCzgFr';
    const UNISWAP_SWAP_TOOL_IPFS_ID = 'QmcKUGUWxpoNNyCBcqdW7cwwxznf6fyYhf5hMQutv7Dcwa';

    const SPENDING_LIMIT_POLICY_IPFS_ID = 'QmP4a8vnQ78BZD9Ht7LZZea4eYcW157Ydc18DoHcktmkPr';
