...
type RawContractMethod = ReturnType<typeof createVincentContracts>['vincentAppViewFacetContract']['read']['getAppByDelegatee'];
...
export async function getAppByDelegatee(request: ExpectedParams, ctx: VincentNetworkContext): Promise<RawContractResponse> {
